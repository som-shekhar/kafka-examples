...
public class PhoneNumber extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PhoneNumber\",\"namespace\":\"com.xorg.employee.schema\",\"fields\":[{\"name\":\"areaCode\",\"type\":\"string\"},{\"name\":\"countryCode\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"prefix\",\"type\":\"string\"},{\"name\":\"number\",\"type\":\"string\"}]}");
  ...
  public static com.xorg.employee.schema.PhoneNumber.Builder newBuilder() {
    return new com.xorg.employee.schema.PhoneNumber.Builder();
  }
  
  /** Creates a new PhoneNumber RecordBuilder by copying an existing Builder */
  public static com.xorg.employee.schema.PhoneNumber.Builder newBuilder(com.xorg.employee.schema.PhoneNumber.Builder other) {
    return new com.xorg.employee.schema.PhoneNumber.Builder(other);
  }
  
  /** Creates a new PhoneNumber RecordBuilder by copying an existing PhoneNumber instance */
  public static com.xorg.employee.schema.PhoneNumber.Builder newBuilder(com.xorg.employee.schema.PhoneNumber other) {
    return new com.xorg.employee.schema.PhoneNumber.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumber>
    ...
    private Builder() {
      super(com.xorg.employee.schema.PhoneNumber.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.xorg.employee.schema.PhoneNumber.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing PhoneNumber instance */
    private Builder(com.xorg.employee.schema.PhoneNumber other) {
            super(com.xorg.employee.schema.PhoneNumber.SCHEMA$);
    ...
    /** Sets the value of the 'areaCode' field */
    public com.xorg.employee.schema.PhoneNumber.Builder setAreaCode(java.lang.CharSequence value) {
    ...
    public com.xorg.employee.schema.PhoneNumber.Builder clearAreaCode() {
      areaCode = null;
    ...
    /** Sets the value of the 'countryCode' field */
    public com.xorg.employee.schema.PhoneNumber.Builder setCountryCode(java.lang.CharSequence value) {
    ...
    public com.xorg.employee.schema.PhoneNumber.Builder clearCountryCode() {
      countryCode = null;
    ...
    /** Sets the value of the 'prefix' field */
    public com.xorg.employee.schema.PhoneNumber.Builder setPrefix(java.lang.CharSequence value) {
    ...
    public com.xorg.employee.schema.PhoneNumber.Builder clearPrefix() {
      prefix = null;
    ...
    /** Sets the value of the 'number' field */
    public com.xorg.employee.schema.PhoneNumber.Builder setNumber(java.lang.CharSequence value) {
    ...
    public com.xorg.employee.schema.PhoneNumber.Builder clearNumber() {
      number = null;
